...
STRA_LOG="/home/u910019/trade/day/backup/sh_stra_${SUFFIX}_`date +%y%m%d`.tar.gz"
...
TICK_DATA="/home/u910019/md/download/day/backup/sh_md_${SUFFIX}_`date +%y%m%d`.tar.gz"
